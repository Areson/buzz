...
export function UserProfilePanel({
  ...
  // Opt-in "Save as persona template" on an existing agent. Reuses main's
  // persona-dialog infra: prefill the editor from the agent so the user
  // reviews and confirms before a template is minted — nothing silent.
  ...
  }, [managedAgent, acpRuntimesQuery.data]);
